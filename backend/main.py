...
SKILL_WHITELIST = [
    "C#", "JavaScript", "TypeScript", "Python", "HTML", "CSS", "JSON", "YAML",
    "Next.js", "React", "GSAP", "FastAPI", "Flask", "Bootstrap", "Tailwind CSS",
    "MySQL", "PostgreSQL", ".NET", "Agile", "REST API", "OAuth2", "Client Credentials",
    "Authorization Code", "Docker", "Docker Compose", "Nginx", "CI/CD", "Prometheus",
    "Grafana", "Hetzner", "Git", "DICOM", "pynetdicom", "Webex Sensoren",
    "Azure Logic Apps", "OpenAI API", "LLM", "GenAI",
]
...
app.add_middleware(
    ...
    allow_origins=["http://localhost:3000",
                   "http://127.0.0.1:3000"],  # meine domains
...
def analyse_daten(daten: AnalyseDaten, request: Request):
    ...
    if len(bucket) >= RATE_LIMIT:
        raise HTTPException(
            status_code=429, detail="Zu viele Anfragen von dieser IP. Bitte kurz warten.")
    bucket.append(jetzt)
...
"""
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"OpenAI API Fehler: {e.message}")
